...
def draw_H_and_E(citys, H_path, energys):
    ...
    for (from_, to_) in H_path:
        ...
        ax1.annotate(s=str(to_+1), xy=citys[to_], xytext=(-8, -4), textcoords='offset points', fontsize=20)
    ax1.axis('equal')
    ax1.grid()
    plt.show()
    # 绘制能量趋势图
...
if __name__ == '__main__':
    ...
    citys = np.array([(47, 47), (33, 4), (37, 12), (10, 15), (21, 38), (2, 10), (20, 36), (25, 49), (27, 43), (40, 20), (22, 48), (36, 24), (39, 17), (48, 44), (14, 11), (4, 27), (45, 41), (19, 19), (32, 14), (50, 16), (28, 8), (6, 30), (34, 34), (23, 2), (26, 7)])
    ...
    for n in range(num_iter):
        ...
        if len(np.unique(route)) == N:
            ...
            if dis < best_distance:
                ...
                [print(str(v+1), end=',' if i < len(best_route) - 1 else '\n') for i, v in enumerate(best_route)]
    if len(H_path) > 0:
